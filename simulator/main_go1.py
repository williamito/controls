...
urdf_path = os.path.join(script_dir, "..", "robot-urdfs", "g1", "g1_23dof.urdf") 

# Load URDF
robot_id = p.loadURDF(urdf_path, useFixedBase=True)

# Find index corresponding to the flange
effector_name = "right_ankle_roll_link"   # left_wrist_roll_rubber_hand
...
current_pos = np.array(link_state[4]) # [0.0, -0.14, -0.13]
