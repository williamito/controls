...
# init interpolator
n_steps = kin._interp_init(kin._forward_kinematics_baseTn(robot_model, q, ee_name_cl), desired_baseTn, freq = 1.0/model.opt.timestep, trans_speed = 0.47, rot_speed = 0.47)
