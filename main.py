...
# Load URDF
model_urdf = URDF_handler()
model_urdf.load(urdf_path)
model_urdf.print_model_properties()
...
# q_init_dh = robot_SO100.from_mech_to_dh(q_init)
...
# q_final_mech = robot_SO100.from_dh_to_mech(q_final_dh)
